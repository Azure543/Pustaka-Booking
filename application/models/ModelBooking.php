...
class ModelBooking extends CI_Model
{
	...
	public function getDataWhere($table, $where): CI_DB_result
	{
		$this->db->where($where);
		return $this->db->get($table);
	}

	public function getOrderByLimit($table, $order, $limit): CI_DB_result
	{
	...
	public function joinOrder($where): CI_DB_result
	{
		$this->db->select('*');
	...
	public function kosongkanData($table): bool
	{
	...
	public function selectJoin(): CI_DB_result
	{
		$this->db->select('*');
